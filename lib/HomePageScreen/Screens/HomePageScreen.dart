...
class _HomePageScreenState extends State<HomePageScreen> {
  ...
  List<Brand> fakeBrands = [
    Brand(name: 'Toyota', imagePath: 'Assets/w.png'),
    Brand(name: 'Honda', imagePath: 'Assets/hynda.png'),
    Brand(name: 'Tesla', imagePath: 'Assets/nissan.png'),
    Brand(name: 'Audi', imagePath: 'Assets/hynda.png'),
    Brand(name: 'BMW', imagePath: 'Assets/w.png'),
  ];

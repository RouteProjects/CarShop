...
import 'CarByBrandScreen.dart';
import 'FilterCarsScreen.dart';
import 'HomePageScreen/Widgets/BrandCard.dart';
import 'HomePageScreen/Widgets/CarCard.dart';
import 'HomePageScreen/Widgets/SearchContainer.dart';
import 'HomePageScreen/Widgets/UserInformation.dart';
                  ...
                  child: BrandCardWidget(
                    ...
                    onTap: () {
                      Navigator.push(
                        context,
                        MaterialPageRoute(
                          builder: (context) => CarByBrandScreen(
                            brand: brand.name,
                            allCars: fakeCars,
                          ),
                        ),
